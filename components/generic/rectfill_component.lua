...
function rectfill_component:set_fill(fill) self.fill = fill or -1 return self end
function rectfill_component:set_border(border) self.border = border or -1 return self end
function rectfill_component:set_border_width(w) self.border_width = w return self end
